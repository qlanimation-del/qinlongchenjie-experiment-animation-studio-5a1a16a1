...
import dustAdd11 from "@/assets/gallery/dust-gallery-add-11.jpg.asset.json";
import dustAdd12 from "@/assets/gallery/dust-gallery-add-12.jpg.asset.json";
import dustAdd13 from "@/assets/gallery/dust-gallery-add-13.jpg.asset.json";
...
export const projects: Project[] = [
  {
    ...
    galleryImages: [
      ...
      { src: dustAdd11.url, alt: "DUST scene design 11" },
      { src: dustAdd12.url, alt: "DUST scene design 12" },
      { src: dustAdd13.url, alt: "DUST scene design 13" },
      ...
      { src: b4, alt: "Beyond gallery 4" },
      { src: b5, alt: "Beyond gallery 5" },
      { src: b6, alt: "Beyond gallery 6" },
    ],
  },
  {
    id: "between-us",
...
pourtant il est toujours empli de croyance.`,
    ...
    exhibitions: {
      en: [
        "2026",
        "\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0⦿\u00A0\u00A0Nature & Culture Poetry Film Festival — Official Selection, Copenhagen, Denmark",
      ],
      zh: [
        "2026",
        "\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0⦿\u00A0\u00A0第六届自然与人文诗歌电影节 — 入选，丹麦哥本哈根",
      ],
      fr: [
        "2026",
        "\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0⦿\u00A0\u00A0Nature & Culture Poetry Film Festival — Sélection officielle, Copenhague, Danemark",
      ],
    },
    glowColor: "#E8A87C",
  ...
  },
  {
    ...
    glowColor: "#4FC3F7",
    medium: {
      en: "Motion graphics, color, sound",
      zh: "动态图形,彩色,有声",
    ...
    commissionedBy: {
      ...
      zh: "广州美术学院委托创作",
      fr: "Commande de l'Académie des Beaux-Arts de Guangzhou",
    },
    courtesy: { en: "Courtesy the artist", zh: "图片由艺术家提供", fr: "Courtoisie de l'artiste" },
  ...
  },
  {
    ...
    glowColor: "#B388FF",
    medium: {
      en: "Naked-eye 3D installation, color, sound",
      zh: "裸眼 3D 装置,彩色,有声",
      fr: "Installation 3D à l'œil nu, couleur, son",
    },
    duration: "4'35\"",
    commissionedBy: {
      en: "Commissioned project",
      zh: "委托创作项目",
      fr: "Projet de commande",
    },
    courtesy: { en: "Courtesy the artist", zh: "图片由艺术家提供", fr: "Courtoisie de l'artiste" },
  ...
  },
  {
    ...
    glowColor: "#00FF88",
    medium: {
      en: "Commercial film, color, sound",
      zh: "商业短片,彩色,有声",
      fr: "Film publicitaire, couleur, son",
    },
    duration: "3'05\"",
    commissionedBy: {
      en: "Commissioned by Beijing Forestry University — Admissions Office",
      zh: "北京林业大学招生办委托创作",
      fr: "Commande du Bureau des admissions, Université forestière de Pékin",
    },
    courtesy: { en: "Courtesy the artist", zh: "图片由艺术家提供", fr: "Courtoisie de l'artiste" },
